...
tf.flags.DEFINE_string("train_file", "./data/train_padding.csv", "Data source for the train.")
...
tf.flags.DEFINE_float("learning_rate", 1e-2, "start learning rate")
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            lr = tf.train.exponential_decay(FLAGS.learning_rate, global_step, 2500, 0.8, staircase=True)
